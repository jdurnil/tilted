...
class ETL_Divilocal extends DiviExtension {
	...
	public $gettext_domain = 'etl-divilocal';
	...
	/**
	 * ETL_Divilocal constructor.
	 *
	 * @param string $name
	 * @param array  $args
	 */
	public function __construct( $name = 'divilocal', $args = array() ) {
